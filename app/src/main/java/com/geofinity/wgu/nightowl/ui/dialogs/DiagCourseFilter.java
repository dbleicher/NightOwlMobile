 ...
 */
public class DiagCourseFilter extends android.support.v4.app.DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // Fill the array
        filterNames = FragCourses.getFilterTitles();
    ...
    private void postSelection(int position) {
        NOMApp.prefs.setCourseFilterNum(position);
